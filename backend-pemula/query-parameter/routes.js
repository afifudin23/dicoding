const routes = [{
    ...
    handler: (req, h) => {
        ...
        if (lang === "id") {
            return `Halo ${username} dari ${locate = locate ?? "Indonesia"}, Selamat datang di Website Ku !!`;
        }
        return `Hello ${username} from ${locate = locate ?? "Indonesian"}, Wellcome in My Website !!`;
